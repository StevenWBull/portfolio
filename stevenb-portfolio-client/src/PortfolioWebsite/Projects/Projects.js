...
export default function Projects()  {
  return (
    <section className="projects">
      <div>
        <a href='https://breadcrumbs.now.sh/' target='_blank' rel="noopener noreferrer"><img src='BreadCrumbs-Home-compressed.jpg' alt='BreadCrumbs' /></a>
        <h4>BreadCrumbs</h4>
      ...
      <div>
        <a href='https://minionese-app.now.sh' target='_blank' rel="noopener noreferrer"><img src='Minionese-compressed.jpg' alt='Minionese Learning App'/></a>
      ...
      <div>
        <a href='https://restaurant-roulette.now.sh/' target='_blank' rel="noopener noreferrer"><img src='Restaurant-Roulette-compressed.jpg' alt='Restaurant Roulette' /></a>
      ...
      <div>
        <a href="https://thinkful-ei-gecko.github.io/smiti-steven-chemistquizapp/" target='_blank' rel="noopener noreferrer"><img src="chemistryKnowledgeQuiz-compressed.png" alt="Chemistry Knowledge Quiz App" /></a>
